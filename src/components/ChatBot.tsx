...
const Chatbot = () => {
  ...
  const [messages, setMessages] = React.useState<{ user: boolean; text: string }[]>([]);
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed bottom-16 right-6 w-80 h-96 bg-white border rounded-lg shadow-lg flex flex-col z-50"
        >
